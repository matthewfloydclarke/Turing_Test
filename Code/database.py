...
def createDatabase():
    try:                                                                                            #Tries to...
        ...
        cur.execute('CREATE TABLE AIs (id INT PRIMARY KEY, inputs TEXT, hiddens INT, weights TEXT, numLayers INT, outputs TEXT)')    #Creates an AIs table which stores the values to make that AI
        con.commit()
        con.close() 
